...
LoadAttributeLoop:
  ...
  LDA #%1001000   ; enable NMI, sprites from Pattern Table 0, background from Pattern Table 1
  STA $2000
...
;;;;;;;;;;;;;;
  ...
  .org $E000
palette:
  .db $2A,$0B,$2D,$30,  $2A,$0B,$2D,$30,  $2A,$0B,$2D,$30,  $2A,$0B,$2D,$30 ;;background palette
  .db $2A,$0B,$2D,$30,  $2A,$0B,$2D,$30,  $2A,$0B,$2D,$30,  $2A,$0B,$2D,$30    ;;sprite palette
